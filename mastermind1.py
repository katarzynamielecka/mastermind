...
class Gracz:
    ...
    def sprawdzanie_poprawności_próby_zgadnięcia(ustawienie_kolorów, kod):
        ...
        dkndm_komputer = Gracz.sprawdzanie_dobry_kolor_miejsce_komp(ustawienie_kolorów, kod)
        dk_komputer = Gracz.sprawdzanie_dobry_kolor_komp(ustawienie_kolorów, kod)
...
kod = ["zielony", "niebieski", "biały", "biały"]
ustawienie_kolorów = ["czarny", "różowy", "biały", "biały"]
Gracz.sprawdzanie_dobry_kolor_miejsce_komp(ustawienie_kolorów, kod)
